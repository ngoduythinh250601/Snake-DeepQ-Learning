...
class GameConf:
    def __init__(self):
        ...
        self.map_width = 480  # pixels
        self.map_height = self.map_width
        self.info_panel_width = 300  # pixels
        ...
        self.save_full_steps = (
            True  # only available on Hamilton solver + Normal Game mode
        )
        ...
        self.color_wall = "#DA3838"
        self.color_food = "#0ED000"
        self.color_snake_eye = "#2109FF"
...
class Game:
    def __init__(self, conf):
        self._conf = conf
        self._map = Map(conf.map_rows + 2, conf.map_cols + 2, conf.map_mode)
        self._snake = Snake(
