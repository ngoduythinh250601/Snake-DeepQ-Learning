...
stones_location = [[],
                   ...
                   [[6, 2], [7, 3], [2, 4], [4, 8], [5, 5], [3, 8], [8, 5], [6, 6]]]


class Map:
    """2D game map."""

    def __init__(self, num_rows, num_cols, map_mode):
        ...
        self._content = [[Point() for _ in range(num_cols)]
    ...
    def reset(self):
        ...
        for stone_pos in stones_location[self.map_mode]:
            self._content[stone_pos[0]][stone_pos[1]].type = PointType.WALL

    def copy(self):
        m_copy = Map(self._num_rows, self._num_cols, self._map_mode)
        for i in range(self._num_rows):
            for j in range(self._num_cols):
    ...
    def is_full(self):
        ...
        for i in range(1, self.num_rows - 1):
            for j in range(1, self.num_cols - 1):
                ...
                if t == PointType.FOOD or t == PointType.EMPTY:
                    return False
        return True
