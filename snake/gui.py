...
class GameWindow(tk.Tk):
    ...
    def __init__(self, title, conf, game_map, game=None, on_exit=None, keybindings=None):
        ...
        self._snake_eye_radius = self._grid_width / 16
        self._init_widgets()
    ...
    def _draw_info_panel(self):
        ...
        self._info_var.set(self._conf.info_str %
                           (self._conf.solver_name, self._conf.mode, status_str,
    ...
    def _draw_grid(self, x, y, t):
        def canvas_draw_rectangle(x, y, r):
            self._canvas.create_rectangle(x - r, y - r, x + r, y + r,
                                          fill=self._conf.color_snake_eye, outline='')
        if t == PointType.WALL:
            self._canvas.create_rectangle(x, y,
                                          x + self._grid_width, y + self._grid_height,
                                          fill=self._conf.color_wall, outline='')
        elif t == PointType.FOOD:
            self._canvas.create_oval(x + self._dx1_food, y + self._dy1_food,
            ...
            canvas_draw_rectangle(
                x + self._grid_width / 2, y + self._grid_height * 3 / 8, self._snake_eye_radius)
            canvas_draw_rectangle(
                x + self._grid_width / 2, y + self._grid_height * 5 / 8, self._snake_eye_radius)
        elif t == PointType.HEAD_U:
            self._canvas.create_rectangle(x + self._dx1, y + self._dy1,
                                          x + self._dx2, y + self._grid_height,
                                          fill=self._conf.color_head, outline='')
            canvas_draw_rectangle(
                x + self._grid_width * 3 / 8, y + self._grid_height / 2, self._snake_eye_radius)
            canvas_draw_rectangle(
                x + self._grid_width * 5 / 8, y + self._grid_height / 2, self._snake_eye_radius)
